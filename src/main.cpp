        ...
        switch (opcion)
        {
            ...
            case 7:
                {   
                    ...
                    std::cout<<"Barcos disponibles para mostrar: ";
                    
                    std::cout<<barcos.cantBarcos<<std::endl;

                    std::cout<<"Ingrese la cantidad de barcos que desee listar"<<std::endl;
